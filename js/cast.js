...
{
    name: "ルシェル(staff)",
    image: "images/lucelleRe.png",
    description: "蝶の使い魔。<br>人間により視界と、羽で飛ぶ自由を奪われてしまったらしい。<br>「これだから人間って〝キライ〟……もちろん、お姉サマのことは ダイスキ ♡」"
},

{
    name: "ヴェイン(staff)",
    image: "images/vayneRe.png",
    description: "カササギの使い魔。<br>しかしカササギと呼ばれることを忌み嫌い、自らをエルスターの使い魔と名乗る。<br>「どうぞご安心を。私は礼節を重んじますので。」"
},
